        ...
        <div>
                 ...
                 <div className="eventsInfo">
                        ...
                        <div className="eventsInfo3">
                                ...
                                <div className="evList">   
                                        <li>Race Course:&ensp;&ensp;&ensp;&ensp;&ensp; 5 climbs and ± 5,000 ft.</li>
                                        <li>Mandatory Gear:&ensp;&ensp;&nbsp;Skis / skins / helmet pack< br />
                                        &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                        beacon / shovel / probe<br />< br/></li>
                                        <li>Recreation Course:&ensp; 3 climbs and ± 2,500 ft.</li>
                                        <li>Mandatory Gear:&ensp;&ensp;&nbsp;Skis / skins / helmet</li>
                                </div>
                                <div className="imgalign3"><a href="https://www.webscorer.com/register?raceid=55916"><img className="race" src="https://s.ws-images.com/uploadedimages/medium/55916_8d2deeff2b83aab.jpg"/></a></div>
                        </div>

                        <div className="eventsInfo4">
