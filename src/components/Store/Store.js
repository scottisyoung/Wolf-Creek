    ...
    return (
        <div>
            <div className="shopParent">
                ...
                <Link className="purchase" to='/lift_tickets'><div className="purchase">Purchase</div></Link></div></div></div>
                ...
                <div className="purchaseParent">
                <Link className="purchase" to='/season_passes'><div className="purchase">Purchase</div></Link></div></div></div>
                ...
                <div className="purchaseParent">
                <Link className="purchase" to='/equipment'><div className="purchase">Reserve</div></Link></div></div></div>
                ...
                <div className="purchaseParent">
                <Link className="purchase" to='/school'><div className="purchase">Reserve</div></Link></div></div></div>
